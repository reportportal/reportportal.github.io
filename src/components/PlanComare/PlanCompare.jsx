  ...
  return (
    <Container>
      <div className={getCompareContainer()}>
        ...
        {!isDesktop && (
          <div className={getCompareContainer('__description')}>Main functionality</div>
        )}
          ...
          <div className={getCompareTable('__row')}>
            ...
            <div className={getCompareTable('__collapsedSection')}>
              <div className={getCompareTable('__rowDescription')}>
                <p>
                  Shared instance is used by more than one tenant/client. Tenants access is
                  restricted to the project space owned by them. Cost-effective option.
                </p>
                <p>
                  Dedicated instance is hosted for one tenant/client only. No shared database and
                  infrastructure — better for data isolation, availability, security and
                  company-based company-based authorization.
                </p>
              </div>
