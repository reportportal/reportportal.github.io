...
export const $colorPrimary600 = '#009dbb';
export const $textService = '#8791ab';
export const $colorPrimary500 = '#00b4d5';
export const $poppinsFont = "'Poppins', Arial, sans-serif";
