export const DASHBOARD_HEADER_INFO = {
  ...
  dashboardText:
    'TAaaS is a part of Testing as a Service followed by outcome-based model of delivery that offers Automation tools, infrastructure, hardware, and expert resources on demand, thus allowing you to optimize your testing costs',
};
