...
const Node = ({ children, direction, row, isDownArrow, number, lastRow }) => (
  ...
  >
    ...
    <p>{children}</p>
    <div className={classNames({ [getBlocksWith('__col-inner-bottom')]: lastRow })} />
  </div>
);

export const EventNode = ({ children, direction }) => (
  <div
    className={classNames(getBlocksWith('__col-action'), {
...
export const ActionNode = ({ children, direction, infoArrow = true, info }) => (
  <div
    className={classNames(getBlocksWith('__col-action'), getBlocksWith('__col-action-info'), {
      [getBlocksWith('__col-action-active')]: !direction,
    })}
  >
    {infoArrow ? (
...
export const Arrow = ({ children, state }) => (
  <div
    className={classNames(getBlocksWith('__btn-arrow-wrapper'), {
      [getBlocksWith('__btn-arrow-active-text')]: state,
    })}
  >
    <span>{children && children}</span>
    <span
      className={classNames(getBlocksWith('__btn-arrow'), {
