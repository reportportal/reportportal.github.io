...
const releases = ['Semi annual product releases', 'Regular service release'];
...
const VersionsBlogPage = () => (
  <>
    ...
    />
    <BlogPageContent title={'New approach to versions naming'}>
      <p>
