...
const TrendsBlogPage = () => (
  <>
    ...
    <BlogPageContent title={'Trends in automated testing in 2023'}>
      ...
      <p>
        Are we just entering this phase? Far from it. We're already deep in it. Visual Testing with image recognition, like in <a target="_blank" href='https://applitools.com/' rel="noreferrer">Applitools</a>, self-healing capabilities for Selenium-based test cases, like in <a target="_blank" href='https://healenium.io/' rel="noreferrer">Healenium</a>, and the analysis and categorization of test results, like in <a target="_blank" href='https://reportportal.io/blog/trends-in-automated-testing-in-2023?utm_source=trigger&utm_medium=rp_1&utm_campaign=trends&utm_content=blog' rel="noreferrer">ReportPortal</a> - all of these are already here. Now they're receiving a new stimulus and renewed interest.
      </p>
      <p>
      ...
      <p>
        <a target="_blank" href='https://reportportal.io/blog/trends-in-automated-testing-in-2023?utm_source=trigger&utm_medium=rp_2&utm_campaign=trends&utm_content=blog' rel="noreferrer">ReportPortal</a> has been addressing this capability for quite some time now. I'm reminded of questions at conferences about 5 years ago along the lines of "Why do we need this?" - now it's not just a possibility, it's a necessity. And we were able to catch this trend in time.
      </p>
      <h3>
        Quality Gates
      </h3>
